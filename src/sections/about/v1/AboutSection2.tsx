import { aboutSectionData2 } from '@/data/about-section/v1/AboutSectionData2';
...
export interface AboutSectionProps2 {
  images: {
    image1: ImageProps;
    image2: ImageProps;
    image3: ImageProps;
      ...
      <Container>
        <div className="grid items-center gap-12 lg:grid-cols-[.92fr_1fr] 2xl:gap-20">
          ...
          <div className="lg:order-2" data-aos="fade-left" data-aos-delay="200">
            ...
            {subtitle2 && (
              <span className="mb-[.625rem] mt-10 block font-secondary text-base font-bold uppercase leading-[1.5] tracking-widest text-primary md:text-md">
                {subtitle2}
              </span>
            )}
            {description && (
