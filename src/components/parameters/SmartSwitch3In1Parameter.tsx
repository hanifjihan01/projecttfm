...
export function SmartSwitch3In1Parameter() {
  const parameters = [
    {
      label: 'Switch Variants',
      value:
        'Available in 1-way, 2-way, and 3-way switch variants under the Dynamax brand.',
    },
    {
      label: 'Operating Voltage',
      value: 'Supports an operating voltage range of AC 96V–264V.',
    },
    {
      label: 'Load Capacity',
      value: 'Each switch channel can handle a maximum power load of 300W.',
    },
    {
      label: 'Lamp Connection Recommendation',
      value:
        'It is not recommended to connect more than 10 lamps in parallel per channel.',
    },
    {
      label: 'Inrush Current',
      value: 'The inrush current should not exceed 78A.',
    },
    {
      label: 'Wiring Method',
      value: 'Uses both neutral and live wires as power sources.',
    },
    {
