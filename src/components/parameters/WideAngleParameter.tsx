...
export function WideAngleParameter() {
  const parameters = [
    {
      label: 'Image Sensor & Lens',
      value:
        'Equipped with T31X+4335 image sensor and a 10x zoom lens (4.7mm-47mm).',
    },
    {
      label: 'Wide-Angle FOV',
    ...
    {
      label: 'Resolution',
      value: 'Supports a resolution of 4 Megapixels.',
    },
    {
      label: 'Video Output',
      value: 'Video output via USB 2.0 connection.',
    },
    {
      label: 'Power Supply',
      value: 'Powered by a DC12V (2A) adapter.',
    },
    {
      label: 'Pan & Tilt Range',
      value: 'Pan range: 0°-355°, tilt range: -30° to +90°.',
    },
    {
      label: 'Zoom Speed',
      value: 'Automatic zoom speed adjustment based on focus.',
    },
  ];
