...
export function SmartGateway4Parameter() {
  const parameters = [
    {
      label: 'Processor',
      value: 'Powered by a dual-core 1.6GHz processor.',
    },
    {
      label: 'Memory & Storage',
      value: 'Equipped with 1GB RAM and 16GB DDR3 internal storage.',
    },
    {
      label: 'Operating System',
      value: 'Operates on Android 5 operating system.',
    },
    {
      label: 'Power Supply',
      value: 'Uses DC 12V power supply with 2A current.',
    },
    {
      label: 'Network Ports',
      value: 'Supports network connectivity with 1 WAN port and 2 LAN ports.',
    },
    {
      label: 'Wireless Communication',
      value: 'Supports wireless communication at 2.4GHz ZigBee frequency.',
    },
  ];
