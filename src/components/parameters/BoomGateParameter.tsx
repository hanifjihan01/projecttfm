...
export function BoomGateParameter() {
  const parameters = [
    {
      label: 'Dimensions',
      value: '150 x 80 x 1224 mm (5.91 x 3.15 x 48.19 inch)',
    },
    {
    ...
    {
      label: 'Dimensions (with Package)',
      value: '258 x 248 x 1293 mm (10.16 x 9.6 x 50.91 inch)',
    },
    { label: 'Power', value: 'Socket Power Supply' },
