...
export function CondenserParameter() {
  const parameters = [
    {
      label: 'Dimensions',
      value: '180mm x 180mm x 45mm.',
    },
    {
      label: 'Weight',
      value: '1.3 kg for a stable and sturdy setup.',
    },
    {
      label: 'Audio Capture Range',
      value: 'Captures audio clearly within a radius of up to 5 meters.',
    },
    {
      label: 'Output',
      value:
