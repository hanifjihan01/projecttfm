...
export function Jvsn936MdlParameter() {
  const parameters = [
    // Video
    ...
    // Lens
    { label: 'Lens', value: '2.8mm (M12)' },
    { label: 'FOV', value: 'H:100.4°, V:53.9°, D:118.6°' },
    { label: 'Lights', value: '2 Warm Light LEDs + 2 IR LEDs' },
    {
      label: 'IR Distance',
      value: 'IR: Up to 30 Meters | Warm Light: Up to 30 Meters',
    },
    ...
    { label: 'Dimensions (W x H x D)', value: '100 x 84 x 100 mm' },
