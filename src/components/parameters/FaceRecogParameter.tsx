...
export function FaceRecogParameters() {
  const parameters = [
    { label: 'Display', value: '8" IPS 1280x800' },
    { label: 'Camera', value: 'Dual 2MP (WOR)' },
    { label: 'Recognition Range', value: '0.2 – 3 meters' },
    { label: 'CPU', value: 'Quad-core ARM' },
    { label: 'Memory', value: '1GB RAM, 8GB ROM' },
    { label: 'OS', value: 'Linux Embedded' },
    { label: 'Interfaces', value: 'LAN, RS232, Relay Out' },
    { label: 'Working Temp', value: '-20°C to 60°C' },
    { label: 'Protection', value: 'IP55 certified' },
  ];
