...
export function Jvsn933YwcParameter() {
  const parameters = [
    { label: 'Model', value: 'JVS-N933-YWC' },
    ...
    { label: 'Maximum Frame Rate', value: '2304x1296@25fps' },
    { label: 'SNR(dB)', value: '52dB' },
    { label: 'Bit Rate', value: '256Kbps～8Mbps' },
    { label: 'Illumination', value: '0Lux (IR ON)' },
    { label: 'Lens', value: '4mm' },
    { label: 'Viewing Angle', value: 'H: 78.5°, V: 42.8°, D: 92.6°' },
    { label: 'IR-LEDs', value: '14µ x 18 LEDs' },
    { label: 'IR-Distance', value: 'Up to 25 Meters' },
    ...
    { label: 'Dimensions (W*H*D)', value: '100*100*85mm' },
    { label: 'Weight', value: '190g' },
    { label: 'Material', value: 'Plastic' },
    { label: 'Working Temperature', value: '-20°C～60°C' },
    { label: 'Humidity', value: 'RH 10%～90%' },
    { label: 'Power Supply', value: 'DC12V' },
    { label: 'Consumption', value: 'Day ≦3W, Night ≦6W' },
