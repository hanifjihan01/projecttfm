...
export function Jvsn917SdlParameter() {
  const parameters = [
    // Image
    ...
    {
      label: 'Bitrate',
      value: 'Main Stream: 256Kbps ~ 4Mbps; Sub Stream: 68Kbps ~ 1024Kbps',
    },
    ...
    { label: 'Lens', value: '3.6mm, 6mm' },
    {
      label: 'FOV',
      value:
        '3.6mm: H 83.8°, V 42.7°, D 100.1°; 6mm: H 52.4°, V 28.4°, D 60.8°',
    },
    ...
    { label: 'Alarm Method', value: 'Email Alarm, Client Alarm' },
    {
      ...
      value:
        'System, Audio and Video, Image, Alarm, Network management, Intelligent Analysis',
    },
    ...
    { label: 'IR Distance', value: 'Up to 50 Meters' },
    ...
    { label: 'Color/Material', value: 'Black and White/Plastic' },
    { label: 'Dimensions (WxHxD)', value: '95x95x175mm' },
    { label: 'Weight', value: '280g' },
    {
      label: 'Installation Method',
      value: 'Wall or ceiling mount (Bracket Optional)',
    },
  ];
