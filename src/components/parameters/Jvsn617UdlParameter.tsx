...
export function Jvsn617UdlParameter() {
  const parameters = [
    // Image
    ...
    { label: 'FOV', value: '3.6mm: H 81.5°, V 40.3°, D 93.8°' },
    ...
    { label: 'Audio Function', value: 'Built-in Mic x 2 and Speaker x 1' },
    ...
    // General
    { label: 'Lights', value: '6 White LEDs + 6 IR LEDs' },
    { label: 'IR Distance', value: 'Up to 60 Meters' },
    { label: 'White Led Distance', value: 'Up to 50 Meters' },
    ...
    { label: 'Color/Material', value: 'Black & White/Metal + Plastic' },
    { label: 'Dimensions (W x H x D)', value: '94.5x94x174.5mm' },
    { label: 'Weight', value: '400g' },
    { label: 'Installation Method', value: 'Ceiling Mount, Wall Mount' },
  ];
