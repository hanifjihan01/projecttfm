...
export function NasStorageParameter() {
  const parameters = [
    {
      label: 'Storage Capacity',
      value: 'Minimum storage capacity of 12TB.',
    },
    {
      label: 'RAID Support',
      value:
        'Supports RAID configurations: 0, 1, 10, 5, and 6 using HDD SAS 6G 7.2K.',
    },
    {
      label: 'Protocol Compatibility',
      value: 'Compatible with NFS and CIFS protocols.',
    },
    {
      label: 'Network Ports',
      value: 'Equipped with four 1Gb Ethernet network ports.',
    },
    {
      label: 'Power Supply',
      value: '1+1 redundant power supply.',
    },
    {
      label: 'Spare Disk',
      value: 'Includes one spare disk (excluding parity).',
    },
    {
      label: 'Warranty',
      value: '3-year warranty coverage.',
    },
  ];
