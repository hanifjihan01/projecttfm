...
export function Jvsn410KParameter() {
  const parameters = [
    // Video
    ...
    { label: 'IR-LEDs', value: '28µ x 4 LEDs' },
    ...
    // Network
    { label: 'Ethernet', value: '10M/100M Ethernet, 1x RJ45' },
