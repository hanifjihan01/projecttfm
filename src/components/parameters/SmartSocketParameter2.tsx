...
export function SmartSocketParameter2() {
  const parameters = [
    {
      label: 'Communication Protocol',
      value: 'Zigbee communication module by Dynamax brand.',
    },
    {
      label: 'Frequency',
      value: 'Operates at a communication frequency of 2.4GHz.',
    },
    {
      label: 'Power Supply',
      value:
        'Powered via USB with a standard USB port for plug-and-play functionality.',
    },
    {
      label: 'Communication Range',
      value:
        'Supports up to 50 meters of communication distance in open areas.',
    },
    {
      label: 'Compatibility',
      value:
    ...
    {
      label: 'Dimensions',
      value: 'Compact design with dimensions of 83mm x 28mm x 13mm.',
    },
  ];
