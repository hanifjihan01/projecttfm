...
export function SmartSocketParameter3() {
  const parameters = [
    {
      label: 'Product Type',
      value: '9W DynaMax LED lamp designed for indoor use.',
    },
    {
    ...
    {
      label: 'Material & Base',
      value: 'Made with a plastic body and uses an E27 base type.',
    },
    {
      label: 'Water Resistance',
      value: 'Not water-resistant (no IP rating).',
    },
  ];
