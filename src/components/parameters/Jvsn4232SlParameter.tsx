...
export function Jvsn4232SlParameter() {
  const parameters = [
    // Image
    { label: 'Image Sensor', value: '1/2.8” CMOS Sensor' },
    { label: 'Max. Resolution', value: '2048x1520' },
    { label: 'Effective Pixels', value: '3.0MP' },
    { label: 'Video Compression', value: 'H.264/H.265' },
    { label: 'Framerate', value: '30fps' },
    { label: 'Bitrate', value: '409Kbps~8Mbps' },
    { label: 'Illumination', value: '0Lux (IR ON)' },

    // Lens
    { label: 'Lens', value: '4 mm' },
    { label: 'Viewing Angle', value: 'H: 79.6°, V: 47.7°, D: 97.8°' },
    { label: 'IR-LEDs', value: '35 Pcs' },
    ...
    { label: 'Starlight', value: 'Support' },

    // Network
    { label: 'Ethernet', value: '1x RJ45 10M / 100M Ethernet' },
    { label: 'Stream', value: '3x Streams' },
    {
      label: 'Protocols',
    ...
    { label: 'Dimension', value: '139.9x101.4mm' },
