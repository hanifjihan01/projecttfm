...
export function Jvsn517TdlParameter() {
  const parameters = [
    ...
    { label: 'Privacy Mask', value: 'Support up to 8 areas' },
    {
      ...
      value:
        'Region Intrusion Detection, Line Crossing Detection, Video Tampering Detection',
    },
    ...
    { label: 'SD Card', value: 'Support (256GB)' },
    { label: 'Expansion Interface', value: 'Built-in MIC and Speaker' },

    // Network
    { label: 'Ethernet', value: '10/100M Ethernet, 1 RJ45' },
    ...
    { label: 'Dimensions (WxHxD)', value: '104x98x184(mm)' },
