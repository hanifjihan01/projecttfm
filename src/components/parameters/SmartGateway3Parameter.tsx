...
export function SmartGateway3Parameter() {
  const parameters = [
    {
      label: 'Power Supply',
      value: 'Operates on DC 12V power with a current of 2A.',
    },
    {
    ...
    },
    {
      ...
      value: 'Supports Android 4.2.1 operating system.',
    },
    {
      label: 'Memory Expansion',
      value: 'Expandable flash memory support up to 32GB.',
    },
    {
      label: 'Network Ports',
      value:
    ...
    },
    {
      ...
      value: 'Supports wireless communication via ZigBee at 2.4GHz frequency.',
    },
    {
      label: 'Applications',
      value: 'Ideal for various applications in smart automation systems.',
    },
  ];
