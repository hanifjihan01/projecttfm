...
export function SmartSwitchCurtainParameter() {
  const parameters = [
    {
      label: 'Power Supply',
      value: 'Device with a voltage range of AC 85V to 265V.',
    },
    {
      label: 'Current & Frequency',
      value: 'Supports current up to 1.25A with a frequency of 50/60Hz.',
    },
    {
      label: 'Load Capacity',
      value: 'Maximum power load capacity is ≤ 300W.',
    },
    {
      label: 'Product Dimensions',
      value: 'Compact dimensions: 86mm x 86mm x 35mm.',
    },
    {
      label: 'Installation Suitability',
      value: 'Suitable for smart home installations.',
    },
    {
      label: 'Application Areas',
      value:
        'Also applicable for smart community, smart hotel, smart building, and smart office systems.',
    },
  ];
