...
export function P4LedFeatures() {
  const features = [
    'Module size: 256mm x 128mm with 4mm pixel pitch and 62,500 pixels/m² density.',
    'Uses SMD1921 technology with a resolution of 64 x 32 dots.',
    'Module thickness: 20mm and weight: 0.6 kg.',
    'Equipped with constant drive system and brightness ≥5000 cd/m².',
    'Bracket size matches module dimensions.',
  ];
    ...
    >
      <div className="mx-auto max-w-screen-xl">
        ...
        <div className="flex flex-col items-center justify-center gap-10 sm:gap-12 lg:flex-row lg:items-start lg:justify-start lg:pl-40">
          ...
          >
            <Image
              src="/assets/images/project/p4led2.png"
              alt="P4 LED Module"
              width={260}
              height={200}
