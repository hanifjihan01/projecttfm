...
export function NasStorageFeatures() {
  const features = [
    'Minimum storage capacity of 12TB.',
    'Supports RAID configurations: 0, 1, 10, 5, and 6 using HDD SAS 6G 7.2K.',
    'Compatible with NFS and CIFS protocols.',
    'Equipped with four 1Gb Ethernet network ports.',
    '1+1 redundant power supply.',
    'Includes one spare disk (excluding parity).',
