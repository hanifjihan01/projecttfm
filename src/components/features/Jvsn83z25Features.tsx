...
export function Jvsn83z25Features() {
  const features = [
    '  4 IR LEDs and 4 White Lights.',
    '   Support Intelligent Analysis Function.',
    '    Human Detection and Tracking .',
    '   Human Intelligent Snapshot Function.',
    '  Support Micro SD Card Storage, Maximum Support 256G.',
  ];
      ...
      <div className="mx-auto max-w-screen-xl">
        ...
        <div className="flex flex-col items-center justify-center gap-10 sm:gap-12 lg:flex-row lg:items-start lg:justify-start lg:pl-40">
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
            viewport={{ once: true }}
            className="w-full px-2 text-base leading-relaxed text-gray-100 sm:text-lg lg:mt-16 lg:px-0"
          >
