...
export function SmartProjectorFeatures() {
  const features = [
    'Equipped with ultra-clear 4K resolution delivering vibrant colors and sharp text.',
    'Elegant full-metal body design with an ultra-slim frame and dual front magnetic pens for ease of use.',
    'Modular computer design (retractable OPS/PC) for easy maintenance.',
    'Supports dual systems (Android and Windows) with one-touch switching for broader software compatibility.',
    'Electronic whiteboard feature supports smooth writing, 20-point touch, annotation, drawing, erasing, image zoom and rotation, and saving whiteboard content via QR code scanning.',
  ];
    ...
    >
      <div className="mx-auto max-w-screen-xl">
        ...
        <div className="flex flex-col items-center justify-center gap-10 sm:gap-12 lg:flex-row lg:items-start lg:justify-start lg:pl-40">
          ...
          >
            <Image
              src="/assets/images/project/smartprojector1.png"
              alt="Smart Projector"
              width={260}
              height={200}
