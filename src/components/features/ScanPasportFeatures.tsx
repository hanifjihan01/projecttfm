...
export function ScanPasportFeatures() {
  const features = [
    ...
    'High-speed scanning performance of up to 200 scans per second.',
    'Includes OCR Processing and Auto Sensor features.',
    'Capable of reading multiple code types: 1D, 2D, QR Code, Data Matrix, PDF417, and OCR Symbologies.',
    'Uses red LED light source for scanning.',
      ...
      <div className="mx-auto max-w-screen-xl">
        ...
        <div className="flex flex-col items-center justify-center gap-10 sm:gap-12 lg:flex-row lg:items-start lg:justify-start lg:pl-40">
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
            viewport={{ once: true }}
            className="w-full px-2 text-base leading-relaxed text-gray-100 sm:text-lg lg:mt-14 lg:px-0"
          >
