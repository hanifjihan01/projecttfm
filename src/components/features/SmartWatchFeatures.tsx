...
export function SmartWatchFeatures() {
  const features = [
    'Supports 4G networks (TDD-LTE/FDD-LTE) and uses a Nano SIM card.',
    'Equipped with GPS, Wi-Fi, and LBS location tracking systems.',
    'Battery capacity: 830mAh with DC5V 1A charging.',
    'Water-resistant with IP67 certification.',
    'Includes health monitoring features.',
  ];
