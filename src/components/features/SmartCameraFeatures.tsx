...
export function SmartCameraFeatures() {
  const features = [
    'Smart detection for people, faces, pets, and vehicles.',
    'Local AI for home automation with activity zones and local (no-cloud) storage.',
    'Integrated with Alexa, Google Assistant, and IFTTT.',
    ...
    'Can function as a Wi‑Fi extender.',
  ];
