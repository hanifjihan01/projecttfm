...
export function Jvsn916MdlFeatures() {
  const features = [
    'Lights On When People Come, Lights Off When People Leave.',
    ' Double Wick, Four warm light, Four infrared.',
    'Support Humanoid Detection',
    ' Support Region Intrusion Detection, Line Crossing Detection, Video Tampering Detection, Defocus Detection.',
