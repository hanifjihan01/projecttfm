...
export function BoomGateFeatures() {
  const features = [
    'Dimensions : 150 x 80 x 1224 mm (5.91 x 3.15 x 48.19 inch)',
    'Weight (with Package) 6 kg (13.23 lb.)',
    'Dimensions (with Package) 258 x 248 x 1293 mm (10.16 x 9.6 x 50.91 inch)',
    ...
    >
      <div className="mx-auto max-w-screen-xl">
        ...
        <div className="flex flex-col items-center justify-center gap-10 sm:gap-12 lg:flex-row lg:items-start lg:justify-start lg:pl-60">
          ...
          >
            <Image
              src="/assets/images/project/plank3.png"
              alt="Autogate Dual"
              width={260}
              height={200}
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
            viewport={{ once: true }}
            className="w-full px-2 text-base leading-relaxed text-gray-100 sm:text-lg lg:mt-11 lg:flex lg:gap-12 lg:px-0"
          >
