...
export function MotorizedFeatures() {
  const features = [
    'The device features a panel size of 558mm x 88mm x 5mm and a box size of 538mm x 75mm x 605mm.',
    'Equipped with a T31X+4335 image sensor and 10X optical zoom lens (4.7mm-47mm).',
    'Wide-angle view: D: 67.6°, H: 64.8°, V: 41.2°; Telephoto view: D: 7.15°, H: 5.8°, V: 4.38°.',
    'Video output via USB2.0.',
