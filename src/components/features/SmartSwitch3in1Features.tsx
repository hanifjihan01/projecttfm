...
export function SmartSwitch3In1Features() {
  const features = [
    'Available in 1-way, 2-way, and 3-way switch variants under the Dynamax brand.',
    'Supports an operating voltage range of AC 96V-264V.',
    'Each switch channel can handle a maximum power load of 300W.',
    'It is not recommended to connect more than 10 lamps in parallel per channel.',
    'The inrush current should not exceed 78A.',
  ];
