...
export function SmartGateway3Features() {
  const features = [
    'Operates on DC 12V power with a current of 2A.',
    'Powered by a dual-core 1.6GHz processor with 1GB RAM and 8GB DDR3 storage.',
    'Supports Android 4.2.1 operating system.',
    'Expandable flash memory support up to 32GB.',
    'Equipped with 1 WAN port and 2 LAN ports for wired network connections.',
    'Supports wireless communication via ZigBee at 2.4GHz frequency.',
    'Ideal for various applications in smart automation systems.',
  ];
      ...
      <div className="mx-auto max-w-screen-xl">
        ...
        <div className="flex flex-col items-center justify-center gap-10 sm:gap-12 lg:flex-row lg:items-start lg:justify-start lg:pl-40">
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
            viewport={{ once: true }}
            className="w-full px-2 text-base leading-relaxed text-gray-100 sm:text-lg lg:mt-12 lg:px-0"
          >
