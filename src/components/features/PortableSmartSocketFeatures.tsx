...
export function PortableSmartSocketFeatures() {
  const features = [
    'Real-time monitoring of power and electricity consumption.',
    'Equipped with an automatic overload alarm for enhanced safety.',
    'Power auto-restart function to maintain stable electrical usage.',
    'Supports plug-and-play functionality for easy setup.',
    'Flexible installation positioning to suit various environments.',
  ];
