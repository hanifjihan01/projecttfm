...
export function MagneticSensorFeatures() {
  const features = [
    ...
    'Operates using two AAA batteries (DC 3V).',
    'Static current consumption: ≤ 9μA.',
    'Emission current consumption: ≤ 28mA.',
    ,
  ];
