...
export function IrRepreatorFeatures() {
  const features = [
    'Consolidates all remote controls into a single mobile app,',
    "Automatic infrared (IR) code matching so users don't need to search for manual codes when pairing devices.",
    'Wide IR transmission angle of 120° for operation ',
    'IR transmission range between 50 and 100 meters for reliable remote operation in typical home environments.',
    'Operates on DC 12V with a maximum working current of ≤ 35 mA.',
    'Main applications include controlling TVs, air conditioners, and audio/video players.',
