...
export function PortableSmartSocket2Features() {
  const features = [
    'Zigbee communication module by Dynamax brand with a communication frequency of 2.4G.',
    'Powered via USB and equipped with a standard USB port for plug-and-play functionality.',
    'Supports communication distance of up to 50 meters in open areas.',
    'Designed for use with smart gateways to securely and easily add devices.',
    'Compact device dimensions: 83mm x 28mm x 13mm.',
  ];
