...
export function SmartCamera2Features() {
  const features = [
    'Equipped with local AI technology and smart home automation.',
    'Supports detection of humans, faces, pets, and vehicles.',
    'Includes activity zones and local storage capabilities.',
      ...
      <div className="mx-auto max-w-screen-xl">
        ...
        <div className="flex flex-col items-center justify-center gap-10 sm:gap-12 lg:flex-row lg:items-start lg:justify-start lg:pl-40">
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
            viewport={{ once: true }}
            className="w-full px-2 text-base leading-relaxed text-gray-100 sm:text-lg lg:mt-4 lg:px-0"
          >
