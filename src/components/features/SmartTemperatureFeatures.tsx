...
export function SmartTemperatureFeatures() {
  const features = [
    ...
    'Equipped with a rechargeable battery, ideal for long-term usage.',
    'Operates on DC 5V power with 500mA current.',
    'Humidity detection range: 15~95% RH, with ±5% RH accuracy and 1% resolution.',
  ];
