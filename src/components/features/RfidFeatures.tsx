...
export function RfidFeatures() {
  const features = [
    'Supports RFID frequencies of 865~868MHz and 902~928MHz.',
    'Compatible with ISO18000-6B/6C (EPC GEN2) protocols.',
    'Reading distance of up to 200 cm.',
    'Runs on Android operating system.',
    'Equipped with NFC functionality.',
    'Commonly used for warehouse management applications.',
  ];
