...
export function WideAngleFeatures() {
  const features = [
    'Equipped with T31X+4335 image sensor and a 10x zoom lens (4.7mm-47mm).',
    'Wide-angle field of view: D: 67.6°, H: 64.8°, V: 41.2°.',
    'Telephoto field of view: D: 7.15°, H: 5.8°, V: 4.38°.',
    'Supports a resolution of 4 Megapixels.',
    'Video output via USB 2.0 connection.',
    'Powered by a DC12V (2A) adapter.',
  ];
        ...
        <div className="flex flex-col items-center justify-center gap-10 sm:gap-12 lg:flex-row lg:items-start lg:justify-start lg:pl-40">
          ...
          >
            <Image
              ...
              alt="Wide-Angle Conference Camera"
              width={260}
              height={200}
