...
export function SmartGateway4Features() {
  const features = [
    'Powered by a dual-core 1.6GHz processor.',
    'Equipped with 1GB RAM and 16GB DDR3 internal storage.',
    'Operates on Android 5 operating system.',
    'Uses DC 12V power supply with 2A current.',
    'Supports network connectivity with 1 WAN port and 2 LAN ports.',
    'Supports wireless communication at 2.4GHz ZigBee frequency.',
  ];
