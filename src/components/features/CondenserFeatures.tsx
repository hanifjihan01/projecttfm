...
export function CondenserFeatures() {
  const features = [
    'Professional USB microphone with dimensions of 180mm x 180mm x 45mm.',
    'Weighs 1.3 kg for a stable and sturdy setup.',
    'Captures audio clearly within a radius of up to 5 meters.',
    'Uses USB output, making it ideal for high-quality recording or conferencing needs.',
  ];
    ...
    >
      <div className="mx-auto max-w-screen-xl">
        ...
        <div className="flex flex-col items-center justify-center gap-10 sm:gap-12 lg:flex-row lg:items-start lg:justify-start lg:pl-40">
          ...
          >
            <Image
              src="/assets/images/project/condenserbaru.png"
              alt="Professional USB Microphone"
              width={260}
              height={200}
