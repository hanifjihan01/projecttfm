...
export function SmartCamera3Features() {
  const features = [
    'Equipped with person detection and facial recognition.',
    'Provides 1080p video resolution with Starlight night vision.',
    'Weather-resistant design with IP65 certification.',
    'Supports 2.4GHz and 5GHz WiFi connections.',
    'Built-in 100dB siren for security alerts.',
    'Two-way audio communication and emergency calling capability.',
  ];
      ...
      <div className="mx-auto max-w-screen-xl">
        ...
        <div className="flex flex-col items-center justify-center gap-10 sm:gap-12 lg:flex-row lg:items-start lg:justify-start lg:pl-40">
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
            viewport={{ once: true }}
            className="w-full px-2 text-base leading-relaxed text-gray-100 sm:text-lg lg:mt-3 lg:px-0"
          >
