...
export function Jvsn915BdlFeatures() {
  const features = [
    '3MP HD resolution.',
    'The default is smart dual light.',
    'Turn off when no human detected',
    'The lights turn on when human detected ',
    'Built-in Mic, Built-in PoE, and IP67.',
  ];
