...
export function Jvsn637UdlFeatures() {
  const features = [
    'Full-Color with Dual Smart Illumination.',
    '  Agi Sense Technology for accurate Humanoid Detection and Vehicle Detection.',
    '  AI-ISP for excellent video performance.',
    '  Built-in Mic and Speaker.',

    'Equipped With unique VQC (Video Quality Catalyst) Technology',
    'Integrated with unique SAFE function ',
  ];
        ...
        <div className="flex flex-col items-center justify-center gap-10 sm:gap-12 lg:flex-row lg:items-start lg:justify-start lg:pl-40">
          ...
          >
            <Image
              ...
              width={260}
              height={200}
              className="mt-7 h-auto w-full rounded-lg object-contain shadow-md"
            />
          </motion.div>
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
            viewport={{ once: true }}
            className="w-full px-2 text-base leading-relaxed text-gray-100 sm:text-lg lg:mt-6 lg:px-0"
          >
