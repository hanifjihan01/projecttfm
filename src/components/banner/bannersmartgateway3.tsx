...
export function BannerSmartGateway3() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      <div className="relative w-full">
        ...
        <Image
          src="/assets/images/project/bannersmartgateway3.png"
          alt="Smart Gateway 3"
          width={1920}
          height={350}
          layout="responsive"
        ...
        >
          ...
          <motion.button
            ...
            onClick={() => {
              router.push('/detailsmartgateway3');
              setTimeout(() => {
                const section = document.getElementById('face-features62');
                if (section) {
