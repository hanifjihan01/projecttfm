...
export function BannerCamAttandance() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      <div className="relative w-full">
        ...
        <Image
          src="/assets/images/project/bannercamattandance.png"
          alt="Led Transparant"
          width={1920}
          height={350}
          layout="responsive"
        ...
        >
          ...
          <motion.button
            ...
            onClick={() => {
              router.push('/detailcamttandance');
              setTimeout(() => {
                const section = document.getElementById('face-features94');
                if (section) {
