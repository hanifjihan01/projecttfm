...
export function BannerCleverDog() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      <div className="relative w-full">
        ...
        <Image
          src="/assets/images/project/bannercleverdog.png"
        ...
        >
          ...
          <motion.button
            ...
            onClick={() => {
              router.push('/detailcleverdog');
              setTimeout(() => {
                const section = document.getElementById('face-features121');
                if (section) {
