...
export function BannerNasStorage() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      <div className="relative w-full">
        ...
        <Image
          src="/assets/images/project/bannernasstorage.png"
          alt="Nas Storage"
          width={1920}
          height={350}
          layout="responsive"
        ...
        >
          ...
          <motion.button
            ...
            onClick={() => {
              router.push('/detailnasstorage');
              setTimeout(() => {
                const section = document.getElementById('face-features71');
                if (section) {
