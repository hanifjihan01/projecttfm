...
export function BannerSmartCamera6() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      <div className="relative w-full">
        ...
        <Image
          src="/assets/images/project/bannersmartcamera4.png"
          alt="Condenser"
          width={1920}
          height={350}
          layout="responsive"
        ...
        >
          ...
          <motion.button
            ...
            onClick={() => {
              router.push('/detailcamerajvszdl');
              setTimeout(() => {
                const section = document.getElementById('face-features106');
                if (section) {
