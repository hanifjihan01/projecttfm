...
export function BannerIrRepreator() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      <div className="relative w-full">
        ...
        <Image
          src="/assets/images/project/bannerirrepreator.png"
        ...
        >
          ...
          <motion.button
            ...
            onClick={() => {
              router.push('/detailirrepreater');
              setTimeout(() => {
                const section = document.getElementById('face-features85');
                if (section) {
