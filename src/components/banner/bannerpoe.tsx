  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      <div className="relative w-full">
        ...
        <Image
          src="/assets/images/project/bannerpoe.png"
          alt="Condenser"
          width={1920}
          height={350}
          layout="responsive"
        ...
        >
          ...
          >
            POE Manageble LS6100G-24P-4X-L3M
          </motion.h1>
          ...
          <motion.button
            ...
            onClick={() => {
              router.push('/detailpoe');
              setTimeout(() => {
                const section = document.getElementById('face-features74');
                if (section) {
