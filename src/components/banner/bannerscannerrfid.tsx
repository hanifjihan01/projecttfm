...
export function BannerScannerRfid() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      <div className="relative w-full">
        ...
        <Image
          src="/assets/images/project/bannerscannerrfid.png"
          alt="Scanner Rfid"
          width={1920}
          height={350}
          layout="responsive"
        ...
        >
          ...
          <motion.button
            ...
            onClick={() => {
              router.push('/detailscannerrfid');
              setTimeout(() => {
                const section = document.getElementById('face-features66');
                if (section) {
