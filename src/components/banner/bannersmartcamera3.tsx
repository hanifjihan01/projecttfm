...
export function BannerSmartCamera3() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      <div className="relative w-full">
        ...
        <Image
          src="/assets/images/project/bannersmartcamera3.png"
          alt="Condenser"
          width={1920}
          height={350}
          layout="responsive"
        ...
        >
          ...
          <motion.button
            ...
            onClick={() => {
              router.push('/detailcamera3');
              setTimeout(() => {
                const section = document.getElementById('face-features103');
                if (section) {
