...
export function BannerJvsn83z25() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      <div className="relative w-full">
        ...
        <Image
          src="/assets/images/project/banner83z25.png"
          alt="Condenser"
          width={1920}
          height={350}
          layout="responsive"
        ...
        >
          ...
          <motion.button
            ...
            onClick={() => {
              router.push('/detailjvsn83z25');
              setTimeout(() => {
                const section = document.getElementById('face-features167');
                if (section) {
