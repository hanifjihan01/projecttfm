...
export function BannerMagneticSensor() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      <div className="relative w-full">
        ...
        <Image
          src="/assets/images/project/bannermagneticsensor.png"
          alt="Smart Locker"
          width={1920}
          height={350}
          layout="responsive"
        ...
        >
          ...
          <motion.button
            ...
            onClick={() => {
              router.push('/detailmagneticsensor');
              setTimeout(() => {
                const section = document.getElementById('face-features51');
                if (section) {
