...
export function BannerWideAngle() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      <div className="relative w-full">
        ...
        <Image
          src="/assets/images/project/bannerwideangle.png"
          alt="Wide Angle"
          width={1920}
          height={350}
          layout="responsive"
        ...
        >
          ...
          <motion.button
            ...
            onClick={() => {
              router.push('/detailwide');
              setTimeout(() => {
                const section = document.getElementById('face-features67');
                if (section) {
