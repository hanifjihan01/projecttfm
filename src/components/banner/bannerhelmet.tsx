  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      <div className="relative w-full">
        ...
        <Image
          src="/assets/images/project/bannerhelmet.png"
        ...
        >
          ...
          <motion.button
            ...
            onClick={() => {
              router.push('/detailsmarthelmet');
              setTimeout(() => {
                const section = document.getElementById('face-features91');
                if (section) {
