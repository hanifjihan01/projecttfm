...
export function BannerLumenLaser() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      <div className="relative w-full">
        ...
        <Image
          src="/assets/images/project/bannerlumenlaser.png"
          alt="Lumen Laser"
          width={1920}
          height={350}
          layout="responsive"
        ...
        >
          ...
          <motion.button
            ...
            onClick={() => {
              router.push('/detaillumenlaser');
              setTimeout(() => {
                const section = document.getElementById('face-features72');
                if (section) {
