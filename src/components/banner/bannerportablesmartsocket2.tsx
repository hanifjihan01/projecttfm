...
export function BannerPortableSmartSocket2() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      <div className="relative w-full">
        ...
        <Image
          src="/assets/images/project/bannerportable2.png"
          alt="Smart Locker"
          width={1920}
          height={350}
          layout="responsive"
        ...
        >
          ...
          <motion.button
            ...
            onClick={() => {
              router.push('/detailportablesmartsocket2');
              setTimeout(() => {
                const section = document.getElementById('face-features38');
                if (section) {
