...
export function BannerSmartGateway() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      <div className="relative w-full">
        ...
        <Image
          src="/assets/images/project/bannersmartgateway.png"
          alt="Smart Gateway"
          width={1920}
          height={350}
          layout="responsive"
        ...
        >
          ...
          <motion.button
            ...
            onClick={() => {
              router.push('/detailsmartgateway');
              setTimeout(() => {
                const section = document.getElementById('face-features60');
                if (section) {
