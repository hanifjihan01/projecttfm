...
export function BannerMeetingTv() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      <div className="relative w-full">
        ...
        <Image
          src="/assets/images/project/bannermeetingtv.png"
          alt="Smart Locker"
          width={1920}
          height={350}
          layout="responsive"
        ...
        >
          ...
          <motion.button
            ...
            onClick={() => {
              router.push('/detailmeetingtv');
              setTimeout(() => {
                const section = document.getElementById('face-features33');
                if (section) {
