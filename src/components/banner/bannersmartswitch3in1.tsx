...
export function BannerSmartSwitch3in1() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      <div className="relative w-full">
        ...
        <Image
          src="/assets/images/project/bannersmartswitch3in1.png"
          alt="Smart Locker"
          width={1920}
          height={350}
          layout="responsive"
        ...
        >
          ...
          <motion.button
            ...
            onClick={() => {
              router.push('/detailsmartswitch3in1');
              setTimeout(() => {
                const section = document.getElementById('face-features41');
                if (section) {
