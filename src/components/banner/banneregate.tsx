  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      <div className="relative w-full">
        ...
        <Image
          src="/assets/images/project/bgegate.png"
        ...
        >
          ...
          <motion.button
            ...
            onClick={() => {
              router.push('/detailegate');
              setTimeout(() => {
                const section = document.getElementById('face-features2');
                if (section) {
