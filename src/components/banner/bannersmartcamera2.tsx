...
export function BannerSmartCamera2() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      <div className="relative w-full">
        ...
        <Image
          src="/assets/images/project/bannersmartcamera2.png"
          alt="Condenser"
          width={1920}
          height={350}
          layout="responsive"
        ...
        >
          ...
          <motion.button
            ...
            onClick={() => {
              router.push('/detailcamera2');
              setTimeout(() => {
                const section = document.getElementById('face-features102');
                if (section) {
