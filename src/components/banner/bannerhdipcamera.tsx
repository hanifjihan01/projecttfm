...
export function BannerHdIpCamera() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      <div className="relative w-full">
        ...
        <Image
          src="/assets/images/project/bannerhdipcamera.png"
        ...
        >
          ...
          <motion.button
            ...
            onClick={() => {
              router.push('/detailcamerahd');
              setTimeout(() => {
                const section = document.getElementById('face-features84');
                if (section) {
