...
export function BannerSmartGateway4() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      <div className="relative w-full">
        ...
        <Image
          src="/assets/images/project/bannersmartgateway4.png"
          alt="Smart Gateway 4"
          width={1920}
          height={350}
          layout="responsive"
        ...
        >
          ...
          <motion.button
            ...
            onClick={() => {
              router.push('/detailsmartgateway4');
              setTimeout(() => {
                const section = document.getElementById('face-features63');
                if (section) {
