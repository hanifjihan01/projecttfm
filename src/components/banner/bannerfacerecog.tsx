...
export function BannerFaceRecog() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      <div className="relative w-full">
        ...
        <Image
          src="/assets/images/project/bannerfacerecog.png"
        ...
        >
          ...
          >
            Face Recognition Thermal MVNT-86
          </motion.h1>
          ...
          <motion.button
            ...
            onClick={() => {
              router.push('/detailfacerecog');
              setTimeout(() => {
                const section = document.getElementById('face-features');
                if (section) {
