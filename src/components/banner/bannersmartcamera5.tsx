...
export function BannerSmartCamera5() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      <div className="relative w-full">
        ...
        <Image
          src="/assets/images/project/bannerkameraoutdoor.png"
          alt="Condenser"
          width={1920}
          height={350}
          layout="responsive"
        ...
        >
          ...
          <motion.button
            ...
            onClick={() => {
              router.push('/detailkameraoutdoor');
              setTimeout(() => {
                const section = document.getElementById('face-features105');
                if (section) {
