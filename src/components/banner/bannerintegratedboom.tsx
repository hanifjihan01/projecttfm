...
export function BannerIntegratedBoom() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      <div className="relative w-full">
        ...
        <Image
          src="/assets/images/project/themeintegratedboom.png"
        ...
        >
          ...
          <motion.button
            ...
            onClick={() => {
              router.push('/boomgate');
              setTimeout(() => {
                const section = document.getElementById('face-features8');
                if (section) {
