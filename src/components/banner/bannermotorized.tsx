...
export function BannerMotorized() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      <div className="relative w-full">
        ...
        <Image
          src="/assets/images/project/bannermotorized.png"
        ...
        >
          ...
          <motion.button
            ...
            onClick={() => {
              router.push('/detailmotorized');
              setTimeout(() => {
                const section = document.getElementById('face-features31');
                if (section) {
