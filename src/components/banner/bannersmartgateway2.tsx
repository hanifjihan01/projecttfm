...
export function BannerSmartGateway2() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      <div className="relative w-full">
        ...
        <Image
          src="/assets/images/project/bannersmartgateway2.png"
          alt="Smart Gateway 2"
          width={1920}
          height={350}
          layout="responsive"
        ...
        >
          ...
          <motion.button
            ...
            onClick={() => {
              router.push('/detailsmartgateway2');
              setTimeout(() => {
                const section = document.getElementById('face-features61');
                if (section) {
