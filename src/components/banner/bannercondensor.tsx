...
export function BannerCondenser() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      <div className="relative w-full">
        ...
        <Image
          src="/assets/images/project/bannercondenser.png"
          alt="Condenser"
          width={1920}
          height={350}
          layout="responsive"
        ...
        >
          ...
          >
            Condenser Microphone USB Professional Speakers
          </motion.h1>
          ...
          <motion.button
            ...
            onClick={() => {
              router.push('/detailcondenser');
              setTimeout(() => {
                const section = document.getElementById('face-features73');
                if (section) {
