...
export function BannerDualGate() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      <div className="relative w-full">
        ...
        <Image
          src="/assets/images/project/bannerdualgate.png"
        ...
        >
          ...
          <motion.button
            ...
            onClick={() => {
              router.push('/detailautogatedual');
              setTimeout(() => {
                const section = document.getElementById('face-features4');
                if (section) {
