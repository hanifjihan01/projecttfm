...
export function LatestCollectioniot2() {
  ...
  useEffect(() => {
    if (window.location.hash === '#latest-products4') {
      setShowAll(true);
      setTimeout(() => {
        const section = document.getElementById('latest-products4');
  ...
  > = {
    Commercial: [
      {
        name: 'Smart Locker',
        image: '/assets/images/project/smartlocker.png',
        link: '/detailsmartlocker',
      },
      {
        name: 'Smart Vending Machine',
        image: '/assets/images/project/smartvending.png',
        link: '/detailsmartvending',
      },
      {
        name: 'M Kios',
        image: '/assets/images/project/mkios.png',
        link: '/detailmkios',
      },
      {
        name: 'Interactive LCD Screen',
        image: '/assets/images/project/layarinteractivelcd.png',
        link: '/detaillayarinteractivelcd',
      },
      {
        name: 'LCD Standing (Digital Signage)',
        image: '/assets/images/project/lcdstanding.png',
        link: '/detaillcdstanding',
      },
    ],
  };
